...
- Update `{CHANGE_DIR}/_state.json` with enriched fields:
  ```json
  {
    "ticket_id": "{ticket_id}",
    ...
    "last_agent": "analyst",
    "phase_history": [{"phase": "S1", "agent": "analyst", "started": "{ISO}", "completed": "{ISO}", "artifacts_produced": ["proposal.md", "spec deltas under specs/ (initial)"], "key_outcome": "{summary}"}],
...
- Update `{CHANGE_DIR}/_state.json`:
  ```json
  {
    ...
    "last_agent": "analyst",
    "phase_history": [
      {"phase": "S1", "agent": "analyst", "started": "...", "completed": "...", "artifacts_produced": ["proposal.md", "spec deltas under specs/ (initial)"], "key_outcome": "..."},
      {"phase": "S2", "agent": "analyst", "started": "...", "completed": "...", "artifacts_produced": ["spec deltas under specs/ (scenarios)", "_handoff.md", "_glossary.md", "_decisions.jsonl"], "key_outcome": "{N} ACs, {M} BRs, spec-auditor PASS, openspec validate PASS"}
    ],
    ...
    "next_action": {
      ...
      "priority_reading": [
        ...
        "spec deltas under the change dir — full AC/scenario details",
