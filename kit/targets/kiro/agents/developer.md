...
**`scope` chưa set khi vào S4** (bugfix/hotfix bỏ qua S1/S2 nên chưa ai định cỡ): root cause rõ ràng, ~1 file / ≤30 dòng, không đổi design → tự set `state-set --set scope=tiny`.
